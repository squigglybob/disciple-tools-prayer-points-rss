...
add_filter( 'dt_post_type_modules', function( $modules ){
    ...
    $modules["starter_base"] = [
        "name" => __( "Starter", "disciple-tools-prayer-points-rss" ),
        "enabled" => true,
        "locked" => true,
        "prerequisites" => [ "contacts_base" ],
        "post_type" => "landing",
        "description" => __( "Default starter functionality", "disciple-tools-prayer-points-rss" )
    ];
...
Disciple_Tools_Prayer_Points_RSS_Base::instance();
